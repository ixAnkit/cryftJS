import Cryft, { HDNode, Mnemonic } from "src"
...
describe("HDNode", (): void => {
  ...
  const addrs: string[] = [
    "X-cryft15qwuklmrfcmfw78yvka9pjsukjeevl4aveehq0",
    "X-cryft13wqaxm6zgjq5qwzuyyxyl9yrz3edcgwgfht6gt",
    "X-cryft1z3dn3vczxttts8dsdjfgtnkekf8nvqhhsj5stl",
    "X-cryft1j6kze9n7r3e8wq6jta5mf6pd3fwnu0v9wygc8p",
    "X-cryft1ngasfmvl8g63lzwznp0374myz7ajt4746g750m",
    "X-cryft1pr7pzcggtrk6uap58sfsrlnhqhayly2gtlux9l",
    "X-cryft1wwtn3gx7ke4ge2c29eg5sun36nyj55u4dle9gn",
    "X-cryft13527pvlnxa4wrfgt0h8ya7nkjawqq29sv5s89x",
    "X-cryft1gw6agtcsz969ugpqh2zx2lmjchg6npklvp43qq",
    "X-cryft10agjetvj0a0vf6wtlh7s6ctr8ha8ch8km8z567"
  ]
